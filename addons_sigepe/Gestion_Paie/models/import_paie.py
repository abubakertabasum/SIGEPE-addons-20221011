        ...
        if self.name:
            ...
            for vals in self:
                if x_ty == 'Fonctionnaire Detaché' or x_ty == 'Fonctionnaire Mis à Disposition' or x_ty == 'FONCTIONNAIRE DETACHE' or x_ty == 'FONCTIONNAIRE MIS A DISPOSITION':
                    ...
                    vals.x_line_ids.unlink()
                    for line in rows:
                        result.append((0, 0, {'mat': line['matricule'], 'nom':line['employe'],'avance_sal': line['base_fp'],'autre_mnt': line['irp'],'categorie': line['categorie'], 'echelle':line['echelle'],'echelon': line['echelon'], 'emploi':line['emploi'],'retenue_totale':line['mnt_total_retenues'],'nbre_charge':line['charge'],'salaire_base':line['salaire_base'],'resp': line['resp'], 'astr':line['astr'],'loge': line['loge'],'tech': line['techn'], 'spec':line['spec'],'sal_brut':line['sal_brut'],'spec_it':line['spec_it'],'spec_ifc':line['spec_ifc'], 'transp':line['transp'], 'inf':line['inf'], 'reseau':line['reseau'], 'financ':line['finance'], 'x_indem_garde':line['garde'], 'x_indem_risque':line['risque'],'x_indem_suj':line['suje'],'x_indem_form':line['formation'],'x_indem_caisse':line['caisse'],'x_indem_veste':line['veste'], 'alloc_f':line['allocation'], 'renum_t':line['remu_total'], 'mnt_agent_carfo':line['carfo'], 'mnt_patronal_carfo':line['p_carfo'], 'mnt_agent_cnss':line['cnss'], 'mnt_patronal_cnss':line['p_cnss'], 'base_imp':line['base_impo'], 'iuts':line['iuts'], 'net':line['net']}))
                    self.x_line_ids = result
                    ...
                    vals.x_line_ids.unlink()
                    for line in rows:
                        result.append((0, 0, {'mat_c': line['matricule_c'], 'num_cnss':line['cnss'],'avance_sal': line['base_fp'],'autre_mnt': line['irp'],'nom':line['employe'],'categorie': line['categorie'], 'echelle':line['echelle'],'echelon': line['echelon'],'retenue_totale':line['mnt_total_retenues'],'nbre_charge':line['charge'], 'emploi':line['emploi'],'salaire_base':line['salaire_base'],'resp': line['resp'], 'astr':line['astr'],'sal_brut':line['sal_brut'],'loge': line['loge'],'tech': line['techn'], 'spec':line['spec'],'spec_it':line['spec_it'],'spec_ifc':line['spec_ifc'], 'transp':line['transp'], 'inf':line['inf'], 'reseau':line['reseau'], 'financ':line['finance'], 'x_indem_garde':line['garde'], 'x_indem_risque':line['risque'],'x_indem_suj':line['suje'],'x_indem_form':line['formation'],'x_indem_caisse':line['caisse'],'x_indem_veste':line['veste'],'x_emolument_ctrct_net':line['emolument'], 'alloc_f':line['allocation'], 'renum_t':line['remu_total'], 'mnt_agent_carfo':line['carfo'], 'mnt_patronal_carfo':line['p_carfo'], 'mnt_agent_cnss':line['cnss'], 'mnt_patronal_cnss':line['p_cnss'], 'base_imp':line['base_impo'], 'iuts':line['iuts'], 'net':line['net']}))
                    self.x_line_ids = result
                elif x_ty == 'Hospitalo-Universitaire' or x_ty == 'HOSPITALO-UNIVERSITAIRE':
                    vals.env.cr.execute("""SELECT (P.id) AS id, (E.x_solde_indiciaire) as base_fp,(E.mnt_total_retenues) as mnt_total_retenues,(E.name) as employe, (E.matricule) as matricule,(E.matricule_genere) as matricule_c,(E.charge) as charge,(E.num_declaration) as cnss,(EM.name) as emploi,(E.x_indem_spec_inspect_irp) as irp, (E.x_solde_indiciaire_ctrct ) as salaire_base, (E.x_indem_resp) as resp, (E.x_indem_astr) as astr, (E.x_indem_techn) as techn, (E.x_indem_specif) as spec,(E.x_indem_spec_inspect_trav) as spec_it,(E.x_indem_spec_inspect_ifc) as spec_ifc, (E.x_indem_loge) as loge, (E.x_indem_transp) as transp, (E.x_indem_inform) as inf, (E.x_indem_exploit) as reseau, (E.x_indem_finance) as finance, (E.x_allocation_familial) as allocation, (E.x_remuneration_total) as remu_total, (E.x_mnt_carfo) as carfo, (E.x_mnt_cnss) as cnss, (E.x_base_imposable_ctrct) as base_impo, (E.x_iuts_net) as iuts,(E.x_mnt_patronal_cnss) as p_cnss,(E.x_mnt_patronal_carfo) as p_carfo, (E.mnt_foner) as foner, (E.x_indem_garde) as garde, (E.x_indem_risque) as risque,(E.x_indem_suj) as suje,(E.x_indem_form) as formation,(E.x_indem_caisse) as caisse,(E.x_indem_veste) as veste,(E.x_emolument_ctrct_net) as emolument,(E.x_net_payer_ctrct) as net FROM  hr_payslip P, hr_employee E, hr_emploi EM WHERE E.id = P.employee_id AND E.x_emploi_id = EM.id AND P.date_from >= %s AND P.date_to <= %s AND E.x_type_employe_id = %s AND E.company_id = %s AND P.state = 'done' AND E.active = 'True' ORDER BY employe ASC""" ,(ddbut,ddfin,x_type_id,x_struct_id))
                    rows = vals.env.cr.dictfetchall()
                    result = []
                    ...
                    vals.x_line_ids.unlink()
                    for line in rows:
                        result.append((0, 0, {'mat_c': line['matricule_c'], 'num_cnss':line['cnss'],'avance_sal': line['base_fp'],'autre_mnt': line['irp'],'nom':line['employe'],'categorie': line['categorie'], 'echelle':line['echelle'],'echelon': line['echelon'],'retenue_totale':line['mnt_total_retenues'],'nbre_charge':line['charge'], 'emploi':line['emploi'],'salaire_base':line['salaire_base'],'resp': line['resp'], 'astr':line['astr'],'loge': line['loge'],'sal_brut':line['sal_brut'],'tech': line['techn'], 'spec':line['spec'],'spec_it':line['spec_it'],'spec_ifc':line['spec_ifc'], 'transp':line['transp'], 'inf':line['inf'], 'reseau':line['reseau'], 'financ':line['finance'], 'x_indem_garde':line['garde'], 'x_indem_risque':line['risque'],'x_indem_suj':line['suje'],'x_indem_form':line['formation'],'x_indem_caisse':line['caisse'],'x_indem_veste':line['veste'],'x_emolument_ctrct_net':line['emolument'], 'alloc_f':line['allocation'], 'renum_t':line['remu_total'], 'mnt_agent_carfo':line['carfo'], 'mnt_patronal_carfo':line['p_carfo'], 'mnt_agent_cnss':line['cnss'], 'mnt_patronal_cnss':line['p_cnss'], 'base_imp':line['base_impo'], 'iuts':line['iuts'], 'net':line['net']}))
                    self.x_line_ids = result
                else:
                    vals.env.cr.execute("""SELECT (P.id) AS id,(C.name) AS categorie, (EC.name) as echelle, (ECH.name) as echelon,(E.x_solde_indiciaire) as base_fp,(E.mnt_total_retenues) as mnt_total_retenues, (E.name) as employe, (E.matricule) as matricule,(E.matricule_genere) as matricule_c,(E.charge) as charge,(E.num_declaration) as cnss,(EM.name) as emploi,(E.x_indem_spec_inspect_irp) as irp, (E.x_solde_indiciaire_ctrct ) as salaire_base, (E.x_indem_resp) as resp, (E.x_indem_astr) as astr, (E.x_indem_techn) as techn, (E.x_indem_specif) as spec,(E.x_indem_spec_inspect_trav) as spec_it,(E.x_indem_spec_inspect_ifc) as spec_ifc, (E.x_indem_loge) as loge, (E.x_indem_transp) as transp, (E.x_indem_inform) as inf, (E.x_indem_exploit) as reseau, (E.x_indem_finance) as finance, (E.x_allocation_familial) as allocation, (E.x_remuneration_total) as remu_total, (E.x_mnt_carfo) as carfo, (E.x_mnt_cnss) as cnss, (E.x_base_imposable_ctrct) as base_impo, (E.x_iuts_net) as iuts,(E.x_mnt_patronal_cnss) as p_cnss,(E.x_mnt_patronal_carfo) as p_carfo,(E.x_salaire_brut) as sal_brut, (E.mnt_foner) as foner, (E.x_indem_garde) as garde, (E.x_indem_risque) as risque,(E.x_indem_suj) as suje,(E.x_indem_form) as formation,(E.x_indem_caisse) as caisse,(E.x_indem_veste) as veste,(E.x_emolument_ctrct_net) as emolument,(E.x_net_payer_ctrct) as net FROM  hr_payslip P, hr_employee E, hr_categorie C, hr_echelle EC, hr_echellon ECH, hr_emploi EM WHERE E.id = P.employee_id AND E.x_categorie_c_id = C.id AND E.x_echelle_c_id = EC.id AND E.x_echellon_c_id = ECH.id AND E.x_emploi_id = EM.id AND P.date_from >= %s AND P.date_to <= %s AND E.company_id = %s AND P.state = 'done' AND E.active = 'True' ORDER BY employe ASC""" ,(ddbut,ddfin,x_struct_id))
                    rows = vals.env.cr.dictfetchall()
                    result = []
                    ...
                    vals.x_line_ids.unlink()
                    for line in rows:
                        result.append((0, 0, {'mat': line['matricule'],'mat_c': line['matricule_c'],'avance_sal': line['base_fp'],'autre_mnt': line['irp'], 'num_cnss':line['cnss'],'nom':line['employe'],'categorie': line['categorie'], 'echelle':line['echelle'],'retenue_totale':line['mnt_total_retenues'],'nbre_charge':line['charge'],'echelon': line['echelon'], 'emploi':line['emploi'],'salaire_base':line['salaire_base'],'sal_brut':line['sal_brut'],'resp': line['resp'], 'astr':line['astr'],'loge': line['loge'],'tech': line['techn'], 'spec':line['spec'],'spec_it':line['spec_it'],'spec_ifc':line['spec_ifc'], 'transp':line['transp'], 'inf':line['inf'], 'reseau':line['reseau'], 'financ':line['finance'], 'x_indem_garde':line['garde'], 'x_indem_risque':line['risque'],'x_indem_suj':line['suje'],'x_indem_form':line['formation'],'x_indem_caisse':line['caisse'],'x_indem_veste':line['veste'],'x_emolument_ctrct_net':line['emolument'], 'alloc_f':line['allocation'], 'renum_t':line['remu_total'], 'mnt_agent_carfo':line['carfo'], 'mnt_patronal_carfo':line['p_carfo'], 'mnt_agent_cnss':line['cnss'], 'mnt_patronal_cnss':line['p_cnss'], 'base_imp':line['base_impo'], 'iuts':line['iuts'], 'net':line['net']}))
                    self.x_line_ids = result
